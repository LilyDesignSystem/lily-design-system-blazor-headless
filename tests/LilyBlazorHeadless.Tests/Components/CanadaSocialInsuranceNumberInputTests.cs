...
public class CanadaSocialInsuranceNumberInputTests : TestContext
{
    [Fact]
    public void Renders_as_text_input_with_kebab_base_class()
    {
        var cut = RenderComponent<CanadaSocialInsuranceNumberInput>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".canada-social-insurance-number-input");
    ...
    {
        var cut = RenderComponent<CanadaSocialInsuranceNumberInput>(p => p
            .Add(x => x.Label, "Label")
