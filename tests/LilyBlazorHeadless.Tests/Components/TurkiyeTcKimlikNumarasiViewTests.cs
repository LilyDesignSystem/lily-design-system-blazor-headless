...
public class TurkiyeTcKimlikNumarasiViewTests : TestContext
{
    [Fact]
    public void Renders_as_span_with_kebab_base_class()
    {
        var cut = RenderComponent<TurkiyeTcKimlikNumarasiView>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".turkiye-tc-kimlik-numarasi-view");
    ...
    {
        var cut = RenderComponent<TurkiyeTcKimlikNumarasiView>(p => p
            .Add(x => x.Label, "Label")
