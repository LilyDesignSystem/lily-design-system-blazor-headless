...
public class MagyarorszagTajSzamInputTests : TestContext
{
    [Fact]
    public void Renders_as_text_input_with_kebab_base_class()
    {
        var cut = RenderComponent<MagyarorszagTajSzamInput>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".magyarorszag-taj-szam-input");
    ...
    {
        var cut = RenderComponent<MagyarorszagTajSzamInput>(p => p
            .Add(x => x.Label, "Label")
