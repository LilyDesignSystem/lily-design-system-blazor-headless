...
public class AotearoaNationalHealthIndexViewTests : TestContext
{
    [Fact]
    public void Renders_as_span_with_kebab_base_class()
    {
        var cut = RenderComponent<AotearoaNationalHealthIndexView>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".aotearoa-national-health-index-view");
    ...
    {
        var cut = RenderComponent<AotearoaNationalHealthIndexView>(p => p
            .Add(x => x.Label, "Label")
