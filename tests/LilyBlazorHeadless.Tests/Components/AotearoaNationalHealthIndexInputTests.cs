...
public class AotearoaNationalHealthIndexInputTests : TestContext
{
    [Fact]
    public void Renders_as_text_input_with_kebab_base_class()
    {
        var cut = RenderComponent<AotearoaNationalHealthIndexInput>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".aotearoa-national-health-index-input");
    ...
    {
        var cut = RenderComponent<AotearoaNationalHealthIndexInput>(p => p
            .Add(x => x.Label, "Label")
