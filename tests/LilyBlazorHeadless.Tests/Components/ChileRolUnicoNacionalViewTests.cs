...
public class ChileRolUnicoNacionalViewTests : TestContext
{
    [Fact]
    public void Renders_as_span_with_kebab_base_class()
    {
        var cut = RenderComponent<ChileRolUnicoNacionalView>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".chile-rol-unico-nacional-view");
    ...
    {
        var cut = RenderComponent<ChileRolUnicoNacionalView>(p => p
            .Add(x => x.Label, "Label")
