...
public class OsterreichSozialversicherungsnummerViewTests : TestContext
{
    [Fact]
    public void Renders_as_span_with_kebab_base_class()
    {
        var cut = RenderComponent<OsterreichSozialversicherungsnummerView>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".osterreich-sozialversicherungsnummer-view");
    ...
    {
        var cut = RenderComponent<OsterreichSozialversicherungsnummerView>(p => p
            .Add(x => x.Label, "Label")
