...
public class YisraelTeudatZehutViewTests : TestContext
{
    [Fact]
    public void Renders_as_span_with_kebab_base_class()
    {
        var cut = RenderComponent<YisraelTeudatZehutView>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".yisrael-teudat-zehut-view");
    ...
    {
        var cut = RenderComponent<YisraelTeudatZehutView>(p => p
            .Add(x => x.Label, "Label")
