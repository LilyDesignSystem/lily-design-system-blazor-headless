...
public class BharatAadhaarViewTests : TestContext
{
    [Fact]
    public void Renders_as_span_with_kebab_base_class()
    {
        var cut = RenderComponent<BharatAadhaarView>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".bharat-aadhaar-view");
    ...
    {
        var cut = RenderComponent<BharatAadhaarView>(p => p
            .Add(x => x.Label, "Label")
