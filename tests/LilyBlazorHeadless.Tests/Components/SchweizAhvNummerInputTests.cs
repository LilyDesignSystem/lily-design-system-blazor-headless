...
public class SchweizAhvNummerInputTests : TestContext
{
    [Fact]
    public void Renders_as_text_input_with_kebab_base_class()
    {
        var cut = RenderComponent<SchweizAhvNummerInput>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".schweiz-ahv-nummer-input");
    ...
    {
        var cut = RenderComponent<SchweizAhvNummerInput>(p => p
            .Add(x => x.Label, "Label")
