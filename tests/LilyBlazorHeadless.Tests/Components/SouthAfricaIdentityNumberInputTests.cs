...
public class SouthAfricaIdentityNumberInputTests : TestContext
{
    [Fact]
    public void Renders_as_text_input_with_kebab_base_class()
    {
        var cut = RenderComponent<SouthAfricaIdentityNumberInput>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".south-africa-identity-number-input");
    ...
    {
        var cut = RenderComponent<SouthAfricaIdentityNumberInput>(p => p
            .Add(x => x.Label, "Label")
