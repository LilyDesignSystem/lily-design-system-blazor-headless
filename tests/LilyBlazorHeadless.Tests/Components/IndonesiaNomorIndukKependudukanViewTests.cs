...
public class IndonesiaNomorIndukKependudukanViewTests : TestContext
{
    [Fact]
    public void Renders_as_span_with_kebab_base_class()
    {
        var cut = RenderComponent<IndonesiaNomorIndukKependudukanView>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".indonesia-nomor-induk-kependudukan-view");
    ...
    {
        var cut = RenderComponent<IndonesiaNomorIndukKependudukanView>(p => p
            .Add(x => x.Label, "Label")
