...
public class UkrayinaReyestratsiyniyNomerOblikovoyiKartkyPlatnykaPodatkivInputTests : TestContext
{
    [Fact]
    public void Renders_as_text_input_with_kebab_base_class()
    {
        var cut = RenderComponent<UkrayinaReyestratsiyniyNomerOblikovoyiKartkyPlatnykaPodatkivInput>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".ukrayina-reyestratsiyniy-nomer-oblikovoyi-kartky-platnyka-podatkiv-input");
    ...
    {
        var cut = RenderComponent<UkrayinaReyestratsiyniyNomerOblikovoyiKartkyPlatnykaPodatkivInput>(p => p
            .Add(x => x.Label, "Label")
