...
public class PrathetThaiLekPrajamTuaPrachachonInputTests : TestContext
{
    [Fact]
    public void Renders_as_text_input_with_kebab_base_class()
    {
        var cut = RenderComponent<PrathetThaiLekPrajamTuaPrachachonInput>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".prathet-thai-lek-prajam-tua-prachachon-input");
    ...
    {
        var cut = RenderComponent<PrathetThaiLekPrajamTuaPrachachonInput>(p => p
            .Add(x => x.Label, "Label")
