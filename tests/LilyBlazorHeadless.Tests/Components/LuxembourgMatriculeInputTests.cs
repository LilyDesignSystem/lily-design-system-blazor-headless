...
public class LuxembourgMatriculeInputTests : TestContext
{
    [Fact]
    public void Renders_as_text_input_with_kebab_base_class()
    {
        var cut = RenderComponent<LuxembourgMatriculeInput>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".luxembourg-matricule-input");
    ...
    {
        var cut = RenderComponent<LuxembourgMatriculeInput>(p => p
            .Add(x => x.Label, "Label")
