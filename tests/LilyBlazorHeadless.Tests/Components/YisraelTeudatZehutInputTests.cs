...
public class YisraelTeudatZehutInputTests : TestContext
{
    [Fact]
    public void Renders_as_text_input_with_kebab_base_class()
    {
        var cut = RenderComponent<YisraelTeudatZehutInput>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".yisrael-teudat-zehut-input");
    ...
    {
        var cut = RenderComponent<YisraelTeudatZehutInput>(p => p
            .Add(x => x.Label, "Label")
