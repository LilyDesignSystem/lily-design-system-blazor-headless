...
public class SingaporeNationalRegistrationIdentityCardInputTests : TestContext
{
    [Fact]
    public void Renders_as_text_input_with_kebab_base_class()
    {
        var cut = RenderComponent<SingaporeNationalRegistrationIdentityCardInput>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".singapore-national-registration-identity-card-input");
    ...
    {
        var cut = RenderComponent<SingaporeNationalRegistrationIdentityCardInput>(p => p
            .Add(x => x.Label, "Label")
