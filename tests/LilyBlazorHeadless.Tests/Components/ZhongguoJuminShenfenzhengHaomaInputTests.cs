...
public class ZhongguoJuminShenfenzhengHaomaInputTests : TestContext
{
    [Fact]
    public void Renders_as_text_input_with_kebab_base_class()
    {
        var cut = RenderComponent<ZhongguoJuminShenfenzhengHaomaInput>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".zhongguo-jumin-shenfenzheng-haoma-input");
    ...
    {
        var cut = RenderComponent<ZhongguoJuminShenfenzhengHaomaInput>(p => p
            .Add(x => x.Label, "Label")
