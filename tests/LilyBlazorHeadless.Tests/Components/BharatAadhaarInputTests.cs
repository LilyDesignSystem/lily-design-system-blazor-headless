...
public class BharatAadhaarInputTests : TestContext
{
    [Fact]
    public void Renders_as_text_input_with_kebab_base_class()
    {
        var cut = RenderComponent<BharatAadhaarInput>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".bharat-aadhaar-input");
    ...
    {
        var cut = RenderComponent<BharatAadhaarInput>(p => p
            .Add(x => x.Label, "Label")
