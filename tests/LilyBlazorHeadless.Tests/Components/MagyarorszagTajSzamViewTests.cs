...
public class MagyarorszagTajSzamViewTests : TestContext
{
    [Fact]
    public void Renders_as_span_with_kebab_base_class()
    {
        var cut = RenderComponent<MagyarorszagTajSzamView>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".magyarorszag-taj-szam-view");
    ...
    {
        var cut = RenderComponent<MagyarorszagTajSzamView>(p => p
            .Add(x => x.Label, "Label")
