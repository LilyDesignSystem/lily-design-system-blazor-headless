...
public class IndonesiaNomorIndukKependudukanInputTests : TestContext
{
    [Fact]
    public void Renders_as_text_input_with_kebab_base_class()
    {
        var cut = RenderComponent<IndonesiaNomorIndukKependudukanInput>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".indonesia-nomor-induk-kependudukan-input");
    ...
    {
        var cut = RenderComponent<IndonesiaNomorIndukKependudukanInput>(p => p
            .Add(x => x.Label, "Label")
