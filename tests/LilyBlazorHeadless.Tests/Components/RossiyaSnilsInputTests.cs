...
public class RossiyaSnilsInputTests : TestContext
{
    [Fact]
    public void Renders_as_text_input_with_kebab_base_class()
    {
        var cut = RenderComponent<RossiyaSnilsInput>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".rossiya-snils-input");
    ...
    {
        var cut = RenderComponent<RossiyaSnilsInput>(p => p
            .Add(x => x.Label, "Label")
