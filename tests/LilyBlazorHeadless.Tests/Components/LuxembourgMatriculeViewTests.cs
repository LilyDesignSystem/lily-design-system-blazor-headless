...
public class LuxembourgMatriculeViewTests : TestContext
{
    [Fact]
    public void Renders_as_span_with_kebab_base_class()
    {
        var cut = RenderComponent<LuxembourgMatriculeView>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".luxembourg-matricule-view");
    ...
    {
        var cut = RenderComponent<LuxembourgMatriculeView>(p => p
            .Add(x => x.Label, "Label")
