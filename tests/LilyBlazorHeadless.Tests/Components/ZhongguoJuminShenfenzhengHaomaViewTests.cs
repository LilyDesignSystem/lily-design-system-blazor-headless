...
public class ZhongguoJuminShenfenzhengHaomaViewTests : TestContext
{
    [Fact]
    public void Renders_as_span_with_kebab_base_class()
    {
        var cut = RenderComponent<ZhongguoJuminShenfenzhengHaomaView>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".zhongguo-jumin-shenfenzheng-haoma-view");
    ...
    {
        var cut = RenderComponent<ZhongguoJuminShenfenzhengHaomaView>(p => p
            .Add(x => x.Label, "Label")
