...
public class SouthAfricaIdentityNumberViewTests : TestContext
{
    [Fact]
    public void Renders_as_span_with_kebab_base_class()
    {
        var cut = RenderComponent<SouthAfricaIdentityNumberView>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".south-africa-identity-number-view");
    ...
    {
        var cut = RenderComponent<SouthAfricaIdentityNumberView>(p => p
            .Add(x => x.Label, "Label")
