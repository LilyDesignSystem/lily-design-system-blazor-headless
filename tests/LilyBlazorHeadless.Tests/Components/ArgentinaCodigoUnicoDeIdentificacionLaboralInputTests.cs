...
public class ArgentinaCodigoUnicoDeIdentificacionLaboralInputTests : TestContext
{
    [Fact]
    public void Renders_as_text_input_with_kebab_base_class()
    {
        var cut = RenderComponent<ArgentinaCodigoUnicoDeIdentificacionLaboralInput>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".argentina-codigo-unico-de-identificacion-laboral-input");
    ...
    {
        var cut = RenderComponent<ArgentinaCodigoUnicoDeIdentificacionLaboralInput>(p => p
            .Add(x => x.Label, "Label")
