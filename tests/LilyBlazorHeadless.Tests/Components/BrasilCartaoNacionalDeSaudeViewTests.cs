...
public class BrasilCartaoNacionalDeSaudeViewTests : TestContext
{
    [Fact]
    public void Renders_as_span_with_kebab_base_class()
    {
        var cut = RenderComponent<BrasilCartaoNacionalDeSaudeView>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".brasil-cartao-nacional-de-saude-view");
    ...
    {
        var cut = RenderComponent<BrasilCartaoNacionalDeSaudeView>(p => p
            .Add(x => x.Label, "Label")
