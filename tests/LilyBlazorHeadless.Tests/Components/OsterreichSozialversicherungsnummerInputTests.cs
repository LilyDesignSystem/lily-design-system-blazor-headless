...
public class OsterreichSozialversicherungsnummerInputTests : TestContext
{
    [Fact]
    public void Renders_as_text_input_with_kebab_base_class()
    {
        var cut = RenderComponent<OsterreichSozialversicherungsnummerInput>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".osterreich-sozialversicherungsnummer-input");
    ...
    {
        var cut = RenderComponent<OsterreichSozialversicherungsnummerInput>(p => p
            .Add(x => x.Label, "Label")
