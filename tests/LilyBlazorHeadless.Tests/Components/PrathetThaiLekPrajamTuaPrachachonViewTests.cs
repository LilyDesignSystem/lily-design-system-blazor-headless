...
public class PrathetThaiLekPrajamTuaPrachachonViewTests : TestContext
{
    [Fact]
    public void Renders_as_span_with_kebab_base_class()
    {
        var cut = RenderComponent<PrathetThaiLekPrajamTuaPrachachonView>(p => p.Add(x => x.Label, "Label"));
        var root = cut.Find(".prathet-thai-lek-prajam-tua-prachachon-view");
    ...
    {
        var cut = RenderComponent<PrathetThaiLekPrajamTuaPrachachonView>(p => p
            .Add(x => x.Label, "Label")
